...
<body class="sb-nav-fixed">
                                    ...
                                    <div class="col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control form-control-sm"
                                                        name="topic_start_date" required min="<?=TALK_DAY_1.'T00:00'?>" max="<?=TALK_DAY_2.'T00:00'?>">
                                                </div>
                                            </div>
                                            <div class=" col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control form-control-sm"
                                                        name="topic_end_date" required min="<?=TALK_DAY_1.'T00:00'?>" max="<?=TALK_DAY_2.'T00:00'?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="text" id="topicBanner" name="topic_banner" hidden>
    ...
    $("#addTopic").submit(function(event) {
        ...
        if ($("#addTopic")[0].checkValidity() === false) {
            ...
            $.ajax({
                url: "<?=base_url('dashboard/admin/topic/submit');?>",
                type: "POST",
                data: form_data,
                processData: false,
                contentType: false,
