                                ...
                                <div class="px-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            ?>
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 mr-2 btn-book btn-<?= $topic_id; ?>" data-topicid="<?php echo $topic_id; ?>" data-topicinfo="<?php echo $arrTopic; ?>" <?php echo $props; ?>>
                                                    Book Now
                                                </div>
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 mr-2 btn-booked hidden btn-<?= $topic_id ?>-booked" hidden>
                                                    Booked
                                                </div>
                                            <?php
                                            } else {
                                            ?>
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 mr-2 btn-booked btn-<?= $topic_id ?>-booked">
                                                    Booked
                                                </div>
                                            <?php
                                            }
                                            ?>
                                            <div div class=" desc-topic nav-link btn btn-sm btn-outline-primary d-inline mb-1 btn-tellme" data-container="body" data-toggle="modal" data-content="<?php echo $row['topic_desc']; ?>" data-target="#uni-story">
                                                Tell Me More
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            ?>
                                                ...
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 mr-2 btn-booked hidden btn-<?= $topic_id ?>-booked">
                                                    Booked
                                                </div>
                                            <?php
                                            } else {
                                            ...
                                            ?>
                                            <div class="desc-topic nav-link btn btn-sm btn-outline-primary d-inline mb-1 btn-tellme" data-container="body" data-toggle="modal" data-content="<?php echo $row['topic_desc']; ?>" data-target="#uni-story">
                                                Tell Me More
                                            </div>
                                        </div>
                                    </div>
                    ...
                    success: function(msg) {
                        ...
                        if (msg == "001") {
                            Swal.fire({
                                ...
                                $(".btn-"+topicId+"-booked").removeClass('hidden').addClass('show');
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
