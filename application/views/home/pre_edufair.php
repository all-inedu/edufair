                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            ?>
                                                ...
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 btn-booked hidden btn-<?= $topic_id ?>-booked">
                                                    Booked
                                                </div>
                                            <?php
                                            } else {
                                            ?>
                                                <div class="nav-link btn btn-sm btn-outline-primary d-inline mb-1 btn-booked btn-<?= $topic_id ?>-booked">
                                                    Booked
                                                </div>
                                            <?php
                                            }
                        ...
                        <div class="submit-cv">
                            ...
                            ?>
                                <a href="<?= base_url() ?>home/dashboard">
                                    <div class="nav-link btn btn-sm btn-outline-primary mb-2 btn-submit-cv btn-<?= $topic_id; ?>" data-topicid="<?php echo $topic_id; ?>" data-topicinfo="<?php echo $arrTopic; ?>" data-param="submit-cv" <?php echo $props; ?>>
                                        Submit CV
                                    </div>
                                </a>
                            <?php
