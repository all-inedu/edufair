                            ...
                            <div class="col-md-4 mb-2 align-items-stretch" id="uni-<?php echo $uniInfo['uni_id']; ?>">
                                <div class="card">
                                    ...
                                    <div class="card-body pl-4 p-1">
                                        <h4 class="m-0 pt-2 pb-2 font-weight-bold" style="color: #3d3d3d; letter-spacing:0.8px;">
                                        ...
                                        <div class="col-md-6 btn-not btn-topic" style="cursor: pointer"
                                            ...
                                            <div class="mx-3">
                                                ...
                                                <?php /*} else*/ if ((count($count_unidtl) > 0) and ($uniInfo['uni_topic_reg'] != "REGISTERED")) { ?>
                                                    <div class="col-md-6 d-inline btn-book-uni book-consultation-container" style="cursor: pointer" data-toggle="modal" data-target="#modal-<?= $uniInfo['uni_id']; ?>"><?php //echo count($count_unidtl); 
                                                                                                                                                                                                                        ?>
                                                    ...
                                                    <div class="col-md-6 desc-uni btn-outline-primary d-inline ml-2 mb-1 btn-tellme btn-topic" class="inst-unilist" data-container="body" data-toggle="modal" data-content="<?php echo $uniInfo['uni_description']; ?>" data-target="#uni-story" style="cursor: pointer">
                                                        Tell Me More
                                                        <!-- <div class="float-right">
                                                    <i class="fas fa-arrow-alt-circle-right"></i>
                                                </div> -->
                                                ...
                                                <?php } else { ?>
                                                    <div class="col-md-10 desc-uni btn-outline-primary d-inline mb-1 btn-tellme btn-topic" class="inst-unilist" data-container="body" data-toggle="modal" data-content="<?php echo $uniInfo['uni_description']; ?>" data-target="#uni-story" style="cursor: pointer">
                                                            ...
                                                            <div class="modal-body">
                                                                                                            ...
                                                                                                            <div data-toggle="buttons" class="btn-group bizmoduleselect tombol">
                                                                                                                <label class="btn btn-booking-uni">
                                                                                                                    <div class="itemcontent">
                                                                                                                        ...
                                                                                                                        <input type="hidden" name="var_id_value[]" value="<?php echo $uni_dtl_id?>">
                                                                ...
                                                                ?>
                                                                    <div class="text-center pb-5 px-3">
                                                                        ...
                                                                        <button data-dismiss="modal" class="btn btn-warning text-dark mt-3 mr-2">Close</button>

                                                                        <button data-uniid="<?php echo $uniInfo['uni_id']; ?>" class="btn btn-primary mt-3 notify-me ml-2">Notify
                                                                            Me</button>
                                                                    </div>
                                                                <?php
                                                                }
