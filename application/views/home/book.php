...
<div class="container-fluid" id="booking">
    <div class="container">
        <div class="row pb-5" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
            <div class="col-12 mt-5 mb-5 text-white p-0">
                <h2>Uni List</h2>
        ...
        <div class="container mt-3 box-book">
            <div class="row my-0" id="consult-container">
                ...
                ?>
                    <div class="col-md-6 mb-4" id="uni-<?php echo $uniInfo['uni_id']; ?>">
                        <div class="card">
                            ...
                            foreach($uniInfo['uni_detail'] as $key => $row) {
                                ...
                                <div class="col">
                                    <button class="btn btn-success btn-block btn-sm btn-book" data-toggle="modal"
                                        <?php echo $disabled; ?> data-target="#day2">Day 2</button>
                                </div>
                                <?php
                                ...
                                <div class="col">
                                    <button class="btn btn-success btn-block btn-sm btn-book" data-toggle="modal"
                                        <?php echo $disabled; ?> data-target="#day2">Day 1</button>
                                </div>
                                <div class="col">
                                    <button class="btn btn-primary btn-block btn-sm btn-book" data-toggle="modal"
                                ...
                                <div class="modal" tabindex="-1" role="dialog"
                                    id="modal<?php echo $row['uni_dtl_id']; ?>">
